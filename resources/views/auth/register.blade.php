    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{isset($user) ? url('/user/update') : route('register') }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                @if(isset($user))
                                <img src="{{ route('getAvatar', $user->id)  }}" class="img-fluid img-circle d-block mb-3" alt="avatar">
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control" name="surname" value="{{isset($user) ? $user->surname : old('surname')}}" required autocomplete="surname" autofocus>
